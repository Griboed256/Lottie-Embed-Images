...
class PreviewServerManager:
    ...
    def start(self, output_jsons: List[Path], log_fn: Optional[Callable] = None) -> None:
        ...
        html_parts = [
            ...
            "<style>",
            "  body{margin:0;background:#1e1e2e;font-family:sans-serif;color:#cdd6f4;display:flex;flex-wrap:wrap;gap:30px;padding:40px;justify-content:center;}",
            "  .card{background:#2a2a3e;padding:20px;border-radius:12px;box-shadow:0 10px 15px rgba(0,0,0,0.3);text-align:center;}",
            "  .anim-container{background:#11111b;border-radius:8px;overflow:hidden;margin-bottom:12px;}",
        ...
        for i, p in enumerate(output_jsons):
            ...
            html_parts.append(f'''
            <div class="card">
                <div id="anim_{i}" class="anim-container" style="width:{w}px;height:{h}px"></div>
